...
HD_PWD='/home/alberto/session2/session2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log s2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source s2.tcl -notrace
