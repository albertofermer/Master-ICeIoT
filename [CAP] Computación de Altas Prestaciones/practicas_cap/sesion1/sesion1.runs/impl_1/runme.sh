...
HD_PWD='/home/alberto/sesion1/sesion1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sesion1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sesion1.tcl -notrace
