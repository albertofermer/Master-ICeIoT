...
HD_PWD='/home/alberto/sesion1/sesion1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sesion1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sesion1.tcl
