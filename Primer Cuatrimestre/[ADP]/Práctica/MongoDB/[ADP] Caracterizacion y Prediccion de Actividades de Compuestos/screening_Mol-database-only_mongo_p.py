...
#################################################################################################################################
#Detalles conexion
#connection_details  = 'mongodb+srv://gcerruela:A1b2c3d4e5F6@cluster0.5m0pk.mongodb.net/?retryWrites=true&w=majority'
# connection_details  = 'mongodb://adp:adp@127.0.0.1:27017'
connection_details  = 'mongodb://afmhuelva:3NZmlzuSchh9J6k4@127.0.0.1:27017'
...
if db_name in database_names:
  ...
  db=client.get_database(db_name);
    ...
    print('Execute: mongorestore mongodb+srv://gcerruela:A1b2c3d4e5F6@cluster0.5m0pk.mongodb.net/?retryWrites=true&w=majority /dump')
